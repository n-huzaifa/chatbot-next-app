...
export default function Chatbot() {
  ...
  return (
    <>
      <div className='flex chatbot-container justify-center'>
      ...
      <div className='chatbot-resolution-page hidden h-screen w-full'>
        <p className='flex flex-col justify-center items-center h-full w-full text-lg font-semibold'>
          Please open the site with a resolution of at least 1024px for the best experience.
        </p>
        <footer className='absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col text-md space-y-4'>
          <span className='font-semibold text-sm cursor-default'>
            developed by <span className='cursor-pointer hover:text-yellow-300 transition duration-300'>Noor </span>
            <span className='cursor-pointer hover:text-red-400 transition duration-300'>ul </span>
            <span className='cursor-pointer hover:text-green-400 transition duration-300'>Islam </span>
