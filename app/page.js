  ...
  return (
    <div className='flex justify-center'>
      {screenWidth > 1024 ? (
        ...
        // Content for lower resolutions
        <div className='flex flex-col h-screen justify-center p-5 max-w-5xl text-black dark:text-white'>
          <h1 className='text-4xl text-center font-bold mb-4'>
            This site is not built for mobile screens. Please try again with a screen greater than 1024px
          </h1>
        </div>
      )}
    </div>
